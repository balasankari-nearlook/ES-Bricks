...
function sendWhatsAppMessage() {
    ...
    // Recipient's WhatsApp number (replace with the desired number, include country code)
    var recipientNumber = "RECIPIENT_WHATSAPP_NUMBER"; // Replace with actual number
    
    // WhatsApp API URL with recipient's number
    var whatsappAPI = "https://wa.me/" + 9790655330 + "?text=" + encodedMessage;
    
    // Open WhatsApp with the message
    window.open(whatsappAPI);
}

// Function to enable/disable the button based on form field validation
function validateForm() {
    ...
    // Enable/disable the button based on form field validation
    if (name !== "" && number !== "" && message !== "") {
